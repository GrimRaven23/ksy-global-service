    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-bg via-white to-bg px-4 safe-area-inset">
      <div className="w-full max-w-sm animate-fade-in">
        ...
        <div className="bg-white border border-bdr rounded-xl p-6 sm:p-7 shadow-sm animate-slide-up">
          ...
          {error && (
            <div className="mb-4 px-3 py-2.5 bg-red-50 border border-red-200 rounded-lg text-xs text-red-700 text-center animate-slide-up">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-3">
              <label className="block text-[10px] font-semibold text-txt2 uppercase tracking-wide mb-1.5">Email</label>
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-txt2" />
                <input
                  type="email"
                  value={email}
            ...
            <div className="mb-5">
              <label className="block text-[10px] font-semibold text-txt2 uppercase tracking-wide mb-1.5">Mot de passe</label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-txt2" />
                <input
